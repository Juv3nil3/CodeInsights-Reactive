...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.juv3nil3.icdg.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.juv3nil3.icdg.security.DomainUserDetailsService", "createSpringSecurityUser");
